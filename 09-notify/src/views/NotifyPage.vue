          ...
          <div class="container con">
            ...
            <div class="notify-wrapper">
              ...
              <div class="notify-title">
                ...
                <!-- svg -->
                <svg @click="getNotifyLazy" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 460.801 460.801" style="enable-background:new 0 0 460.801 460.801;" xml:space="preserve"><g>
                  <path d="M231.298,17.068c-57.746-0.156-113.278,22.209-154.797,62.343V17.067C76.501,7.641,68.86,0,59.434,0
                          ...
                          c122.533,0.331,222.134-98.734,222.465-221.267C452.896,117,353.832,17.399,231.298,17.068z"/></g></svg>
...
export default {
  ...
  methods: {
    ...
    getNotify() {
      ...
      axios
        ...
        .then(response => {
          let messages = [], messagesMain = [], data = response.data.notify
  ...
  computed: {
    messages() { return this.$store.getters.getMessageMain }
  },
}
</script>
